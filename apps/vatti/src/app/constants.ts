export const Constants = {
  routes: {
    ...
    POST_OFFICE_SAVINGS_SCHEMES: 'post-office-savings-schemes',
    SETTINGS: 'settings',
    ABOUT: 'about',
    PRIVACY: 'privacy',
    TERMS: 'terms',
  ...
  jsonBlobs: {
    POST_OFFICE_SAVINGS_SCHEMES: '1328064967722852352',
    RBI_POLICY_RATES: '1328296657577762816',
    BANKS_IN_INDIA_JSON_BLOB: '1328392058737713152',
    IBJA_GOLD_RATES_JSON_BLOB: '1328432133789900800',
  },
  settings: {
    THEME: 'theme',
